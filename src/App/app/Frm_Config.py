...
#        QtGui.QMainWindow.__init__(self, None, QtCore.Qt.WindowStaysOnTopHint)
        ...
        #Pestaña Directorios
        self.txt_DirEstructura.setText(self.cfg['Directorios']['Datos']['Estructura'])
        self.txt_DirSeaSaveV7.setText(self.cfg['Directorios']['Datos']['seasave7'])
        self.txt_DirSeaSaveini.setText(self.cfg['Directorios']['Datos']['seasaveini'])
        #Pestaña Campaña
        ...
        #Pestaña Puertos
        #GPS - COM
        self.chk_GPS.setChecked(int(self.cfg['Configuracion']['NMEA']['Status']))
        self.cbox_GPS_COM.addItem(self.cfg['Configuracion']['NMEA']['Port']) 
        self.cbox_GPS_COM.setCurrentText(self.cfg['Configuracion']['NMEA']['Port'])
        #GPS Baud Rate
        self.cbox_GPS_BR.addItems(['4800','9600'])
        self.cbox_GPS_BR.setCurrentText(str(self.cfg['Configuracion']['NMEA']['BR']))
        #CTD - COM
        self.chk_CTD.setChecked(int(self.cfg['Configuracion']['CTD']['Status']))
        self.cbox_CTD_COM.addItem(self.cfg['Configuracion']['CTD']['Port'])
        self.cbox_CTD_COM.setCurrentText(self.cfg['Configuracion']['CTD']['Port'])
        #CTD Baud Rate
        self.cbox_CTD_BR.addItems(['600','1200','4800','9600','19200'])
        self.cbox_CTD_BR.setCurrentText(str(self.cfg['Configuracion']['CTD']['BR']))
        #TSG - COM
        self.chk_TSG.setChecked(int(self.cfg['Configuracion']['TSG']['Status']))
        self.cbox_TSG_COM.addItem(self.cfg['Configuracion']['TSG']['Port'])
        self.cbox_TSG_COM.setCurrentText(self.cfg['Configuracion']['TSG']['Port'])
        #TSG Baud Rate
        self.cbox_TSG_BR.addItems(['600','1200','4800','9600'])
        self.cbox_TSG_BR.setCurrentText(str(self.cfg['Configuracion']['TSG']['BR']))
        #BAT - COM
        self.chk_BAT.setChecked(int(self.cfg['Configuracion']['Batimetria']['Status']))
        self.cbox_BAT_COM.addItem(self.cfg['Configuracion']['Batimetria']['Port'])
        self.cbox_BAT_COM.setCurrentText(self.cfg['Configuracion']['Batimetria']['Port'])
        #BAT Baud Rate
        self.cbox_BAT_BR.addItems(['4800','9600'])
        self.cbox_BAT_BR.setCurrentText(str(self.cfg['Configuracion']['Batimetria']['BR']))
    ...
    def click_btn_Guardar(self, event):
        ...
        self.cfg['Configuracion']['NMEA']['Status'] = str(self.chk_GPS.checkState())
        ...
        #Datos Instrumentos
        #CTD
        self.cfg['Configuracion']['CTD']['Variables'] = str(self.spinBox_CTD.value())
        nom_fila = list()
        ...
        #TSG
        self.cfg['Configuracion']['TSG']['Variables'] = str(self.spinBox_TSG.value())
        nom_fila = list()
